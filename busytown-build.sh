...
function stage1build() {
	...
	-DCMAKE_SHARED_LINKER_FLAGS="-fuse-ld=lld -static-libstdc++" \
	-DCMAKE_MODULE_LINKER_FLAGS="-fuse-ld=lld -static-libstdc++" \
