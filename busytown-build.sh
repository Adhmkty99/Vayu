...
function stage2Build() {
      ...
      $CMAKE \
        ...
        -DCMAKE_LINKER=$HOST_CLANG_BIN/ld.lld \
        -DCMAKE_AR=$HOST_CLANG_BIN/llvm-ar \
        -DCMAKE_EXE_LINKER_FLAGS="-fuse-ld=$HOST_CLANG_BIN/ld.lld -static-libstdc++" \
        -DCMAKE_SHARED_LINKER_FLAGS="-fuse-ld=$HOST_CLANG_BIN/ld.lld -static-libstdc++" \
        -DCMAKE_MODULE_LINKER_FLAGS="-fuse-ld=$HOST_CLANG_BIN/ld.lld -static-libstdc++"
